import os
from knowledge_scraper import KnowledgeScraper, DocProcessor
...
large_html = "<html><main><h1>Start</h1>" + ("<p>Word </p>" * 1000) + "<h1>End</h1></main></html>"

scraper = KnowledgeScraper("sources.toml", ".knowledge")
scraper.process_and_save("mock_lib", "test.html", DocProcessor.html_to_markdown(large_html))
